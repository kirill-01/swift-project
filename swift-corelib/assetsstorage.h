...
public:
    ...
    QList<quint32> getActiveMarkets() const;

    quint32 getArbitragePairByCoins( const quint32& base, const quint32& market ) const;
    ...
    QString getCurrencyCoinName( const quint32& currency_id ) const;
