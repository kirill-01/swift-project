...
void SwiftApiClientKuCoin::getMarkets(const QJsonObject &j_params, const quint64 &async_uuid)
{
    ...
    Q_UNUSED(j_params)
    QNetworkRequest req(QUrl("https://openapi-v2.kucoin.com/api/v1/symbols") );
    QNetworkReply * rep = getManager()->get( req );
    rep->setProperty("uuid", async_uuid );
}
...
{
    Q_UNUSED(j_params)
    QNetworkRequest req(QUrl("https://openapi-v2.kucoin.com/api/v1/market/orderbook/level2_20?symbol="+SwiftCore::getAssets()->getMarketName( j_params.value("market_id").toString().toUInt() ) ) );
...
void SwiftApiClientKuCoin::withdrawCreate(const QJsonObject &j_params, const quint64 &async_uuid)
{
    ...
    quint64 ts = QDateTime::currentMSecsSinceEpoch();
    const QString cname = SwiftCore::getAssets()->getCurrencyName( currency );
    ...
    params["amount"] = QString::number( (j_params.value("amount").toString().toDouble() - (SwiftCore::getAssets()->getCurrencyCoin( currency ) == 1 ? 0.0005 : 5 ) ) ,'f', 8 );
...
void SwiftApiClientKuCoin::withdrawInner(const QJsonObject &j_params, const quint64 &async_uuid)
{
    ...
    params["currency"] = SwiftCore::getAssets()->getCurrencyName( j_params.value("currency_id").toString().toUInt() );
...
{
    quint64 ts = QDateTime::currentMSecsSinceEpoch();
    const QString pname( SwiftCore::getAssets()->getMarketName( j_params.value("market_id").toString().toUInt() ) );
...
void SwiftApiClientKuCoin::transferToTrades() {
    ...
    QList<quint32> _currencies( SwiftCore::getAssets()->getExchangeCurrencies( getExchangeId() ) );
