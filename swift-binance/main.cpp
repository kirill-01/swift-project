...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setApplicationName("swift-binance");
    ...
    parser.setApplicationDescription("Binance API client module for swift bot system");
    ...
    SwiftApiClientBinance * api_client = new SwiftApiClientBinance(nullptr);
    QObject::connect( wamp_client.data(), &WampClient::clientConnected, api_client, &SwiftApiClient::onWampSession);
    SwiftApiParserBinance * api_parser = new SwiftApiParserBinance();
