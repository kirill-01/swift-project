...
int main(int argc, char *argv[])
{
    ...
    if ( QFile::exists( "/opt/swift-bot/modules/balance/balance.dist" ) ) {
        QSettings dist_settings( "/opt/swift-bot/modules/balance/balance.dist", QSettings::IniFormat );
        QSettings current_settings( "/opt/swift-bot/modules/balance/balance.ini", QSettings::IniFormat );
        ...
        QFile::remove( "/opt/swift-bot/modules/balance/balance.dist" );
    }
    ...
    QObject::connect( wamp_client, &WampClient::clientConnected, bals_keeper, &BalancesKeeper::onWampSession );
