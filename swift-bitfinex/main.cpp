...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setApplicationName("swift-bitfinex");
    ...
    parser.setApplicationDescription("Bitfinex API client module for swift bot system");
    ...
    SwiftApiClientBitfinex * api_client = new SwiftApiClientBitfinex(nullptr);
    QObject::connect( wamp_client.data(), &WampClient::clientConnected, api_client, &SwiftApiClient::onWampSession);
    SwiftApiParserBitfinex * api_parser = new SwiftApiParserBitfinex();
